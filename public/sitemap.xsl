...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9">
  <xsl:template match="/">
    <html>
      ...
      <body>
        <h1>XML Sitemap - PranjalDev</h1>
        <div class="meta">
          <p>This is the XML sitemap for PranjalDev, which is used to inform search engines about pages on our site that are available for crawling.</p>
